...
import com.bsilva.rpgtext.story_handle.ChapterStory;
import com.bsilva.rpgtext.story_handle.Scene;
...
public class TextRPGActivity extends AppCompatActivity implements TypeWriterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fontSize = sharedPreferences.getInt("font_size", 12);

        sceneText.setTextSize((float) fontSize);
